  ...
  return (
    <div className="relative w-full">
      <textarea
        ...
        spellCheck={false}
        className={cn(
          "relative z-10 w-full resize-none border-0 bg-transparent text-left text-base font-medium leading-none",
      ...
      {showGhost && prefersReducedMotion && reducedStatic && (
        <div
          className="pointer-events-none absolute inset-0 z-[5] flex items-start text-left text-base font-medium leading-none text-washed-700"
          aria-hidden
        >
